          ...
          <div className="container">
            <div className="row">
              <div className="col-xs-12 col-lg-7 first-lg">
                <Description>
                  В конце прошлого года мы пересмотрели формат нашего бара, расположенного на первом этаже, и решили
                  немного расширить его функционал. Уверены что в этом формате он понравится Вам ещё больше - мы
                  сохранили Караоке, стали открывать свои двери помимо выходных в четверг и воскресенье, и существенно
                  обновили меню.
                </Description>
                <Description>
                  Самое важное изменение - многократное расширение ассортимента пива - как на кране, так и бутылочного.
                  Теперь мы сотрудничаем с российскими крафтовыми пивоварнями, а так же привозим интересные сорта из
                  других стран. Ждём Вас на дегустацию - у нас можно найти много интересных сортов и новых вкусовых
                  ощущений.
                </Description>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-xs-12 col-lg-6 last-xs">
                <Image src={beer} alt="более 40 сортов пива" title="более 40 сортов пива" />
              </div>
              <div className="col-xs-12 col-lg-6 last-lg">
                <Card>
                  <Description>
                    Новый ассортимент разливного и бутылочного пива придется по душе как любителям насыщенного эля, так
                    и ценителям легкого лагера. Собрали лучшее из таких стран как Бельгия, Чехия , Германия, Англия, а
                    так же добавили продукции отечественного производства и небольших пивоварен. Суммарно получилось
                    более 40 сортов, но эта цифра не является постоянной, так как мы регулярно обновляем своё меню и
                    привозим новинки.
                  </Description>
                </Card>
              </div>
